...
# ==============================================================================
# PAGE 1: HASIL PRINCALS (CACHED READS)
# ==============================================================================
if page == "Hasil PRINCALS":
    st.markdown('<p class="section-header">1. Transformasi Dimensi <span>PRINCALS</span></p>', unsafe_allow_html=True)
...
# ==============================================================================
# PAGE 2: HASIL CLUSTERING (INDIVIDUAL SHEET VIEWER - CACHED)
# ==============================================================================
elif page == "Hasil Clustering":
    st.markdown('<p class="section-header">2. Eksperimen <span>Algoritma Clustering</span></p>', unsafe_allow_html=True)
...
# ==============================================================================
# PAGE 3: PERBANDINGAN METODE
# ==============================================================================
elif page == "Perbandingan Metode":
    st.markdown('<p class="section-header">3. Perbandingan <span>Performa & Ranking</span></p>', unsafe_allow_html=True)
...
# ==============================================================================
# PAGE 4: EVALUASI SILHOUETTE & BSS/TSS
# ==============================================================================
elif page == "Evaluasi Silhouette & BSS/TSS":
    st.markdown('<p class="section-header">4. Evaluasi <span>Silhouette & BSS/TSS Ratio</span></p>', unsafe_allow_html=True)
...
# ==============================================================================
# PAGE 5: VISUALISASI CLUSTER (DYNAMIC SEMESTERS)
# ==============================================================================
elif page == "Visualisasi Cluster":
    st.markdown('<p class="section-header">5. Visualisasi <span>Cluster & Analisis Dimensi</span></p>', unsafe_allow_html=True)
...
# ==============================================================================
# PAGE 6: DASHBOARD INSIGHT
# ==============================================================================
elif page == "Dashboard Insight":
    st.markdown('<p class="section-header">6. Dashboard Insight <span>& Rekomendasi Akademik</span></p>', unsafe_allow_html=True)
...
# ==============================================================================
# PAGE 7: MAHASISWA BERPRESTASI
# ==============================================================================
elif page == "Mahasiswa Berprestasi":
    st.markdown('<p class="section-header">7. Analisis <span>Mahasiswa Berprestasi & Rekomendasi</span></p>', unsafe_allow_html=True)
